        ...
        takeInput(
          ...
          (message: string) => {
            sendCommands([
              ...
              git_commands.git_reset_hard("origin/release"),
        ...
        takeInput(
          ...
          (message: string) => {
            sendCommands([
              ...
              git_commands.git_reset_hard("origin/fb_integration"),
              git_commands.git_pull_rebase,
              git_commands.git_merge_no_ff_no_commit(branch),
              git_commands.git_commit_m(message),
...
export const gitUpdatePatchsetIntegration = commands.registerCommand(
  "mmt-extranet-git-commands.git_update_patchset_in_integration",
  () => {
    getCurrentBranch((branch: string) => {
      takeInput(strings.reset_to_commit, "", (url: string) => {
        takeInput(
          strings.message_placeholder,
          branch + " | ",
          (message: string) => {
